...
import TabAdimPedido from "./Adm_TabPedidoFerias";
import NavHComponent from "./navbarhori";
//
import { userLoggedIn } from "../store/store";


export default function AdmPedidoFerias() {
  return (
                ...
                <div className="card-header pb-0 p-3">
                  <div className="row">
                    <div className="col-6 d-flex align-items-center">
                      <h6 className="mb-0">Pedido de Férias</h6>
                    </div>
                  </div>
                  <div className="card-body px-0 pt-0 pb-2 margin-table">
                    <div className="table-responsive p-0">{TabAdimPedido()}</div>
                  </div>
                </div>
              </div>
            </div>
