...
import TabAdminNotificacoes from "./Adm_TabNotificacoes";
import NavHComponent from "./navbarhori";
//
import { userLoggedIn } from "../store/store";


export default function AdmNotificacoes() {
  return (
            ...
            <div className="col-12">
              <div className="row">
                ...
                <div className="col-6 text-end position-btn-novo">
                      <Link
                        to="/Nova-Notificacao" className="btn bg-gradient-dark mb-0 btn-cor">
              ...
              <div className="card mb-4 color-table">
                <div className="card-header pb-0 p-3">
                  ...
                  <div className="card-body px-0 pt-0 pb-2 margin-table">
                    <div className="table-responsive p-0">{TabAdminNotificacoes()}</div>
                  </div>
                </div>
              </div>
            </div>
